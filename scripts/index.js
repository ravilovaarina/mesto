...
function addFormSubmit(evt) {
    ...
    cardsElement.querySelector('.cards__pic').src =  urlInput.value;
    cardsElement.querySelector('.cards__text').textContent = placeInput.value;
...
// удаление карточки мяу)
const deletecard = (evt) => {
    const card = evt.closest('.cards__item');
    card.remove();
}