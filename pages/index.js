...
const placePopup = new PopupWithForm(popupAdd, (place) => {
    const newPlaceCard = new Card(place, cardsTemplate, handleCardClick);
    const newPlace = newPlaceCard.generateCard();
...
const aboutPopup = new PopupWithForm(popupEdit, () => {
    user.setUserInfo(nameInput, bioInput)
})
